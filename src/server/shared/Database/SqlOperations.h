...
class SqlQuery : public SqlOperation
{
    ...
    public:
        SqlQuery(const char *sql, Skyfire::IQueryCallback * callback, SqlResultQueue * queue)
...
class SqlQueryHolder
{
    ...
    public:
        ...
        bool Execute(Skyfire::IQueryCallback * callback, SqlDelayThread *thread, SqlResultQueue *queue);
};
...
class SqlQueryHolderEx : public SqlOperation
{
    private:
        ...
        SqlResultQueue * m_queue;
    public:
        SqlQueryHolderEx(SqlQueryHolder *holder, Skyfire::IQueryCallback * callback, SqlResultQueue * queue)
