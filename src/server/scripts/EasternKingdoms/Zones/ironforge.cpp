...
bool GossipHello_npc_royal_historian_archesonus(Player* player, Creature* creature)
{
...
bool GossipSelect_npc_royal_historian_archesonus(Player* player, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
{
    switch (uiAction)
    {
